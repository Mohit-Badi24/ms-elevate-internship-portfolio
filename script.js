...
const data = {
  ...
  weeks: {
    ...
    4: {
      ...
      tasks: [
        ...
        },
        {
          ...
          github:
            "https://app.powerbi.com/links/Q8QphtOe_i?ctid=a6d41119-cfd2-440f-9ef3-442f6aa1c738&pbi_source=linkShare&bookmarkGuid=206daab6-6a4b-4608-be35-cff69ce3619b",
        },
      ],
    },
    5: {
      ...
      tasks: [
        {
          ...
          screenshots: [],
          github:
            "https://colab.research.google.com/drive/1p8zsvSAOhzL1ikbqtgmUErkQ3ETM4iKL?usp=sharing",
        },
        {
          ...
          screenshots: [],
          github:
            "https://colab.research.google.com/drive/1OYpJo0QoOlQ2XyyXGt0ekpD3HBQkpNtN?usp=sharing",
        },
        {
          ...
          screenshots: [],
          github:
            "https://colab.research.google.com/drive/1X8RHp1p7A5hfc7PFtgtugNjRWOHBuTY5?usp=sharing",
        },
      ],
    },
    6: {
      ...
      tasks: [
        {
          ...
          github:
            "https://colab.research.google.com/drive/1PM1cg3uEwJPYaowohP8TE5uKZ4JhOucB?usp=sharing",
        },
        {
          ...
          github:
            "https://colab.research.google.com/drive/1w5pD6mtqsLWzjRBVIDTB3x5imqd2VoW4?usp=sharing",
        },
      ],
    },
    7: {
      ...
      tasks: [
        {
          title:
            "Task 1: Convolutional Neural Network Implementation using CIFAR-10",
          ...
          github:
            "https://colab.research.google.com/drive/1jEDv7ffUG5_3krQ_gWV-LX6ZphOIuSO7?usp=sharing",
        },
        {
          title:
            "Task 2: TensorFlow & Keras Model Saving and Inference Pipeline",
        ...
        },
        {
          ...
          github:
            "https://colab.research.google.com/drive/1VjLQ8Gt1cLVuwT1GQeOE7bH7ax1nuH2q?usp=sharing",
        },
      ],
    },
    8: {
      title: "Week 8 – AI Tools & Cloud Computing",
      days: [
        {
          date: "13th March 2026 (Friday)",
          topic: "Microsoft Copilot",
          learned: [
            "Introduction to Microsoft Copilot as an AI-powered coding assistant",
            "Understanding how Copilot helps in code generation and debugging",
            "Explored usage of Copilot for writing simple programs and functions",
            "Learned how prompt-based instructions improve AI-generated output",
            "Understood how AI tools increase developer productivity",
          ],
        },
        {
          ...
          learned: [
            "Introduction to cloud computing and its importance in modern applications",
            "Difference between on-premise systems and cloud-based systems",
            "Understanding types of cloud: Public, Private, and Hybrid",
            "Learned cloud service models: IaaS, PaaS, and SaaS",
            "Benefits of cloud computing such as scalability, flexibility, and cost efficiency",
          ],
        },
        {
          date: "18th March 2026 (Wednesday)",
          topic: "Microsoft Azure Introduction",
          learned: [
            "Introduction to Microsoft Azure cloud platform",
            "Understanding Azure portal and basic navigation",
            "Learned about core services like Virtual Machines and Storage",
            "Concept of Resource Groups and service management",
            "Understanding how applications are deployed on cloud platforms",
          ],
        },
      ],
      tasks: [],
    ...
    9: {
      title: "Week 9 – Azure Experiments",
      days: [
        {
          date: "20th March 2026 (Friday)",
          topic: "Azure Experiments",
          learned: [
            "Explored practical implementation of Microsoft Azure cloud platform",
            "Understood how to navigate Azure portal and manage different services",
            "Learned creation of basic cloud resources such as Virtual Machines and Storage",
            "Understood how applications and services are deployed on cloud environment",
            "Explored monitoring and management of cloud resources in real time",
            "Learned importance of cloud computing in modern application development",
          ],
        },
        {
          ...
          topic: "Azure Experiments",
          learned: [
            "Performed hands-on practice with Azure services and resource management",
            "Learned how to create, configure and manage cloud resources",
            "Understood deployment workflow of applications on Azure platform",
            "Explored starting, stopping and monitoring cloud services",
            "Analyzed how cloud services provide scalability and flexibility",
            "Gained practical understanding of real-world cloud applications",
          ],
        },
      ],
      tasks: [
        {
          title: "Task 1: Basic Azure Resource Exploration",
          description: [
            "Objective: To understand basic cloud service operations using Microsoft Azure platform.",
            "Explored Azure portal interface and its various cloud services.",
            "Created a basic resource such as Virtual Machine or Storage service.",
            "Observed how cloud resources are configured, deployed and managed.",
            "Understood real-time monitoring and usage of cloud services.",
          ],
          implementation: [
            "Logged into Microsoft Azure portal.",
            "Navigated through different cloud services available.",
            "Created a basic resource (Virtual Machine or Storage).",
            "Configured required settings and deployed the resource.",
            "Monitored resource status and verified successful deployment.",
          ],
          screenshots: [],
          github: "",
        },
    ...
    10: {
      title: "Week 10 – Project Finalization & Presentation",
      days: [
        {
          date: "25th March 2026 (Wednesday)",
          topic: "Project Finalization",
          learned: [
            "Completed integration of all implemented models and components",
            "Reviewed machine learning, deep learning, and analysis modules",
            "Ensured correctness of outputs and proper execution of code",
            "Organized project workflow for better understanding",
            "Prepared final documentation for submission",
          ],
        },
        {
          date: "27th March 2026 (Friday)",
          topic: "PPT Submission",
          learned: [
            "Created structured presentation explaining project workflow",
            "Included problem statement, methodology, and results",
            "Added model outputs, graphs, and performance metrics",
            "Organized slides in clear and professional format",
            "Prepared for explaining project during evaluation",
          ],
        },
        {
          ...
          learned: [
            "Submitted final project with complete documentation",
            "Verified outputs and results for accuracy",
            "Ensured all implemented modules are working correctly",
            "Reviewed project before submission",
            "Prepared for final viva and evaluation",
          ],
        },
      ],

      overview: [
        "The project focuses on implementing core Artificial Intelligence and Machine Learning concepts.",
        "Multiple models such as Logistic Regression, Random Forest, ANN, and CNN were developed and evaluated.",
        "Data preprocessing, visualization, and performance evaluation techniques were applied.",
        "Clustering and reinforcement learning concepts were also implemented.",
        "A portfolio website was created to showcase weekly progress and project work.",
      ],

      tasks: [],
    },
    11: {
      title: "Week 11 – Project Implementation & Modeling",
      days: [
        {
          date: "1st April 2026 (Wednesday)",
          topic: "Project Implementation",
          learned: [
            "Worked on complete implementation of internship project",
            "Applied machine learning models such as Logistic Regression and Random Forest",
            "Structured workflow from data preprocessing to model prediction",
            "Integrated different components such as data, models and outputs",
            "Focused on understanding each step of implementation clearly",
            "Improved code readability and simplified logic for better understanding",
          ],
        },
        {
          date: "3rd April 2026 (Friday)",
          topic: "Model Development",
          learned: [
            "Trained machine learning models on selected dataset",
            "Compared performance of models using accuracy metrics",
            "Understood working of classification models in detail",
            "Analyzed prediction results and model behavior",
            "Improved model performance using basic techniques",
          ],
        },
      ],
      screenshots: ["images/week11_1.png", "images/week11_2.png"],
      tasks: [],
    },
    12: {
      title: "Week 12 – Testing, Debugging & Final Submission",
      days: [
        {
          date: "6th April 2026 (Monday)",
          topic: "Testing & Debugging",
          learned: [
            "Tested complete project for errors and correctness",
            "Debugged issues in code and improved logic flow",
            "Verified outputs of machine learning models",
            "Ensured all components are working properly",
            "Improved overall project stability and performance",
          ],
        },
        {
          ...
          learned: [
            "Prepared final version of project for submission",
            "Reviewed all concepts learned during internship",
            "Organized project files and documentation",
            "Ensured project is ready for evaluation and presentation",
            "Completed final submission successfully",
          ],
        },
      ],
      screenshots: ["images/week12_1.png", "images/week12_2.png"],
      tasks: [],
    },
  },
};
...
/* ✅ ADD SCREENSHOTS AT END */
if (week.screenshots && week.screenshots.length > 0) {
  contentHTML += `
    <div class="task-section">
      <h3 class="highlight-heading">Project Screenshots</h3>
      ${week.screenshots.map((img, i) => `
        <img src="${img}" class="task-image" alt="Screenshot ${i+1}">
      `).join("")}
    </div>
  `;
}
...
contentHTML += `</div>`;
    ...
    if (week.tasks && week.tasks.length > 0) {
      ...
      taskContainer.innerHTML = week.tasks
        .map(
          (task, index) =>
...
>>>>>>> b4ec8f9b60fb33a80da8fb34b93ee8cf5f1800bc
